...
app.get('/api/message/:id/replies', require('./endpoints/message/replies').get)
...
app.post('/api/admin/permissions', globalPermissionsMiddleware(["adminAccess", "managePermissions"]), require('./endpoints/admin/permissions').add)
...
app.post('/api/admin/permissions/:userId/bulk', globalPermissionsMiddleware(["adminAccess", "managePermissions"]), require('./endpoints/admin/permissions').bulkSet)
app.delete('/api/admin/permissions/:userId', globalPermissionsMiddleware(["adminAccess", "managePermissions"]), require('./endpoints/admin/permissions').remove)
